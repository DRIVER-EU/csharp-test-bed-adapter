...
namespace eu.driver.model.sim.request
{
	...
	public partial class RequestInformation : ISpecificRecord
	{
		...
		/// <summary>
		/// Unique identifier of the entity the applicant requests information about
		/// </summary>
		...
		public virtual Schema Schema
		{
			get
			{
				return RequestInformation._SCHEMA;
			}
		}
		/// <summary>
		/// Unique identifier of the request
